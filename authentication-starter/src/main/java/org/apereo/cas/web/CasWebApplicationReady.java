...
public class CasWebApplicationReady implements CasWebApplicationReadyListener {
    ...
    public void handleApplicationReadyEvent(final ApplicationReadyEvent event) {
        ...
        AsciiArtUtils.printAsciiArtReady(log, "CAS is now running at " + properties.getServer().getPrefix());
        
        log.info("Ready to process requests @ [{}]", DateTimeUtils.zonedDateTimeOf(Instant.ofEpochMilli(event.getTimestamp())));
